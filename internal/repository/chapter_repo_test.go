...
func TestFileChapterRepository(t *testing.T) {
	...
	// 5. Check atomic file creation on disk
	expectedFile := filepath.Join(tempDir, "chapters", newChap.ID+".md")
