...
func DefaultCommands() []CommandItem {
	return []CommandItem{
		...
		},
		{
			...
			Category:    "Navegación",
			Shortcut:    "alt+1",
			Description: "Abrir la sección de capítulos (1 fuera de textos, alt+1 siempre)",
		},
		{
			ID:          "tab_characters",
			...
			Category:    "Navegación",
			Shortcut:    "alt+2",
			Description: "Abrir la sección de personajes (2 fuera de textos, alt+2 siempre)",
		},
		{
			ID:          "tab_notes",
			Title:       "Ir a Notas",
			Category:    "Navegación",
			Shortcut:    "alt+3",
			Description: "Abrir la sección de notas (3 fuera de textos, alt+3 siempre)",
		},
		{
			ID:          "tab_brain",
			...
			Shortcut:    "alt+4",
			Description: "Abrir la memoria Brain (4 fuera de textos, alt+4 siempre)",
		},
		{
			ID:          "toggle_timeline",
